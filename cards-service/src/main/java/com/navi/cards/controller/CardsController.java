...
import com.navi.cards.properties.CardsInfo;
...
@RestController
@RequestMapping(path = "/cards-service", produces = {MediaType.APPLICATION_JSON_VALUE})
@AllArgsConstructor
@Validated
public class CardsController {
    ...
    @GetMapping("/info")
    public ResponseEntity<CardsInfo> getInfo() {
